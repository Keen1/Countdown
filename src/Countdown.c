...
int main(int argc, char *argv[]) {
    ...
    gtk_box_set_homogeneous(GTK_BOX(stopwatch_button_box), TRUE);  // Make items have equal space
    stopwatch_button = gtk_button_new_with_label("Start Stopwatch");
    gtk_box_pack_start(GTK_BOX(stopwatch_button_box), stopwatch_button, TRUE, FALSE, 0);  // Center the button
    gtk_widget_set_halign(stopwatch_button_box, GTK_ALIGN_CENTER);  // Align the box center horizontally
    ...
    gtk_box_pack_start(GTK_BOX(timer_entries_box), gtk_label_new("Hours:"), TRUE, FALSE, 0);
    gtk_box_pack_start(GTK_BOX(timer_entries_box), hours_entry, TRUE, FALSE, 0);
    gtk_box_pack_start(GTK_BOX(timer_entries_box), gtk_label_new("Minutes:"), TRUE, FALSE, 0);
    gtk_box_pack_start(GTK_BOX(timer_entries_box), minutes_entry, TRUE, FALSE, 0);
    gtk_box_pack_start(GTK_BOX(timer_entries_box), gtk_label_new("Seconds:"), TRUE, FALSE, 0);
    gtk_box_pack_start(GTK_BOX(timer_entries_box), seconds_entry, TRUE, FALSE, 0);
    gtk_widget_set_halign(timer_entries_box, GTK_ALIGN_CENTER);  // Center align the entries box
    ...
    gtk_box_set_homogeneous(GTK_BOX(timer_button_box), TRUE);
    timer_button = gtk_button_new_with_label("Start Timer");
    gtk_box_pack_start(GTK_BOX(timer_button_box), timer_button, TRUE, FALSE, 0);
    gtk_widget_set_halign(timer_button_box, GTK_ALIGN_CENTER);
